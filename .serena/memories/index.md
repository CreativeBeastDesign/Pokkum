...
| `mem:self_review_checklist` | 56-row cross-harness bug-pattern checklist (verified 2026-08-22 — re-check the count before citing it, it grows often) — read whole, not summarized | Before declaring any non-trivial diff complete |
